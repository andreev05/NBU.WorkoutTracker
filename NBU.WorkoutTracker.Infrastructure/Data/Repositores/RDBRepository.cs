...
namespace NBU.WorkoutTracker.Infrastructure.Data.Repositores
{
    /// <summary>
    ...
    public class RDBRepository<T> : IRDBERepository<T> where T : class
    {
        /// <summary>
        /// Entity framework DB context holding connection information and properties
        /// and tracking entity states 
        /// </summary>
        protected WorkoutTrackerDbContext Context { get; set; }
        ...
        public RDBRepository(WorkoutTrackerDbContext context) {
